      ...
      {({ open }) => (
        <div className="relative min-w-32">
          ...
          <Transition
            ...
            leaveTo="opacity-0"
          >
            <ListboxOptions className="absolute z-50 mt-1 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
              {items.map((statPage) => (
                <ListboxOption
                  key={statPage.id}
